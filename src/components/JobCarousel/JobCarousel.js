            ...
            <div className="container">
              <div className="row">
                <div className={`${CSS.imgContainer} row`}>
                  ...
                  />
                  <div
                    className={`${CSS.jobType} ${currentJob.jobType} fw-bold  p-1 w-fit text-uppercase text-center text-white`}
                  >
                    {currentJob.jobType}
                  </div>
                </div>
                <img
                  ...
                  alt=""
                />
                <h4 className={`fw-bold ${CSS.jobTitle}`}>
                  {currentJob.jobtitle}
                </h4>
                <div>
                  <span className={`fw-bold ${CSS.companyName}`}>
                    {currentJob.companyName} |
                  </span>
                  <span className={CSS.companySlogan}>
                    {" "}
                    {currentJob.slogan}
                  </span>
                </div>
